...
public class Lista<T> implements Coleccion<T> {
    ...
    /**
     * Crea una lista ordenada donde se combinan la lista con la lista pasada 
     * (Se supone que estas están ordenadas).
     * @param l2 la lista ordenada con la que se quiere combinar.
     * @param comparador el comparador con el que se ordenara la nueva lista.
     */
	...
	while(l != 0) {
	    l1.agregaFinal(iterador.next());
	    l--;
	}
	while(iterador.hasNext())
	    l2.agregaFinal(iterador.next());
    ...
    public boolean busquedaLineal(T elemento, Comparator<T> comparador) {
        Nodo n = cabeza;
        while(n != null && comparador.compare(n.elemento,elemento)<=0){
